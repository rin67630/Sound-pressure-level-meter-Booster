...
#define SOUND_SOURCE_IS_A0     //_A0 _URL _UDP _NONE     Change end accordingly
#define PANEL_VOLTAGE_IS_URL    //_A0 _NONE 
...
#define Console2 Serial     // Port for midnight report e.g. on thermal printer
#define Console3 Serial      // Port for boot messages
#define Console4 Serial1      // Port for AK-Outputs
...
#define OPEN_WEATHER_MAP_APP_ID      "208085abb5a3859d1e32341d6e1f079f9"
