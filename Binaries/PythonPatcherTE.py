...
print ("Welcome to PythonPatcher Thinger-Edition for ESP devices ")
print ("from RIN67630 @ https://github.com/rin67630/ESP_Binary_patcher")
print ("Please read the instruction file to pre-configure a new account/device at Thinger.io: PreConfigureThinger.txt")
